...
const ProfileTop = ({profile:{ status,designation,
company,location,website,social,user:{name,avatar}}
    ...
    return (
        ...
        <div className="icons my-1">
            ...
            <i className="fas fa-globe fa-2x" title="website"></i>
          </a>}
          {social && social.twitter &&   <a href={social.twitter} target="_blank" rel="noopener noreferrer">
            <i className="fab fa-twitter fa-2x" title="twitter"></i>
          </a>}
        ...
        {social && social.youtube && 
         ...
         <i className="fab fa-youtube fa-2x" title="youtube"></i>
       </a>
        }  
